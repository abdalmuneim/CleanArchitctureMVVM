...
TextStyle getLightStyle({double fontSize = FontsSize.s12, required color}) {
...
TextStyle getSemiBoldStyle({double fontSize = FontsSize.s18, required color}) {
  return _getTextStyle(fontSize, FontWeightManger.semiBold, color);
}

/// Bold Font Style

TextStyle getBoldStyle({double fontSize = FontsSize.s20, required color}) {
